...
module.exports = {
    ...
    */
    getEmployeesFromDB: (query)=> {
        ...
        return new Promise(async (resolve, reject)=> {
            try{
                let docs = await dbUtil.getFromDB(constants.COLLECTION_EMP, query);
                for(let doc of docs){
                    employees.push(doc);
                }
                resolve(employees)
   ...
   */
    ...
    /*
      ...
      * @returns: Promise object
      */
    insertSeat: (coord, seatNo, empName, empTeam, empPhone, mapName)=>{
        ...
        return new Promise(async (resolve, reject)=>{
            ...
            try{
                let seatDoc = {"coord": coord, "seatNo": seatNo, "empName": empName, "empTeam":empTeam, "empPhone": empPhone, "mapName":mapName};
    ...
    renameMap: (mapName, newName)=>{
        ...
        return new Promise(async (resolve, reject)=>{
            ...
            try{
                ...
                await dbUtil.executeTransactionRenameMap(mapName, newName);
